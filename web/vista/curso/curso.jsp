<%-- 
    Document   : curso
    Created on : 28-abr-2020, 17:38:56
    Author     : Jaasiel
--%>
                ...
                <div class="container-fluid p-3">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="nav?to=crear-curso" class="btn btn-success mb-2">Crear un curso</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="nav?to=edit-curso" class="btn btn-info btn-sm">Editar</a>
