<%-- 
    Document   : nuevo-curso
    Created on : 28-abr-2020, 17:45:44
    Author     : Jaasiel
--%>
                    ...
                    <div class="mx-auto" style="width: 800px;">
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="curso?action=new">
                                    
                                    <div class="form-group row">
                                        
                                        <label class="col-sm-3" for="nombre">Nombre del curso</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2" for="inicio">Hora Inicio</label>
                                        <div class="col-sm-4">
                                            <input type="time" class="form-control" id="inicio" name="inicio">
                                        </div>
                                        <label class="col-sm-2" for="fin">Hora Fin</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <button type="submit" class="btn btn-success btn-sm btn-lg btn-block">Guardar</button>
                                        </div>
                                    </div>
