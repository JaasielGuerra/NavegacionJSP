<%-- 
    Document   : alumno
    Created on : 28-abr-2020, 13:23:01
    Author     : Jaasiel
--%>
                ...
                <div class="container-fluid p-3">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="nav?to=crear-alumno" class="btn btn-success mb-2">Crear un nuevo alumno</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="nav?to=edit-alumno" class="btn btn-info btn-sm">Editar</a>
